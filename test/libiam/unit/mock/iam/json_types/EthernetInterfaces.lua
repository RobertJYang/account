...
---@class EthernetInterfaces.Channel
...
---@param obj EthernetInterfaces.Channel
...
EthernetInterfaces.Channel = TChannel

---@class EthernetInterfaces.Status
...
---@param obj EthernetInterfaces.Status
...
EthernetInterfaces.Status = TStatus
...
EthernetInterfaces.interface = mdb.register_interface('bmc.kepler.Managers.EthernetInterfaces', {
    ...
    Status = {'b', {'EMIT_CHANGE'}, true, nil, false},
    Channel = {'y', {}, false, nil, false},
