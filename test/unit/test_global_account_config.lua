...
function TestAccount:test_when_unsername_valid_should_check_success()
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('Administrator'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name(string.rep('A', 16)))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('A#dministrator'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('A+dministrator'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('A-dminis_trator'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('.A..dministrator'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('.A..d_123'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('...!@#$^*()-=+_'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('_={};[]?.'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('[Admin]'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('Ad{mi}n'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name(']Adm;i]n'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('.Admin..'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('_dm=in?'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('[[[Ad}}}min{{'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('|.root|'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('adm|in+1#'))
    lu.assertIsTrue(self.test_global_account_config.m_account_policy:check_user_name('t1@#!~`$^*()-_+?'))
end

--- 用户名不合法，应该检查失败
function TestAccount:test_when_unsername_invalid_should_check_fail()
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name(''))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('.'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('..'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name(' Administrator'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name(string.rep('A', 17)))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('A:dministrator'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('A<dministrator'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('A>dministrator'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('A&dministrator'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('A,dministrator'))
    ...
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('-Administrator'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('A“dministrator'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('Administrator\r'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('Administrator\n'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('Administrator\f'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('Administrator\r\n\f'))
    lu.assertIsFalse(self.test_global_account_config.m_account_policy:check_user_name('Administrator\n\n'))
