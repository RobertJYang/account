...
local TPCM_DEVICE_GROUP_NAME   = "tpcm_device"
...
local TSB_USER_GID = 105
local TPCM_DEVICE_GID = 106
...
local TSB_USER_UID = TSB_USER_GID
...
return {
  ...
  TPCM_DEVICE_GROUP_NAME = TPCM_DEVICE_GROUP_NAME,
  ...
  TSB_USER_GID = TSB_USER_GID,
  TPCM_DEVICE_GID = TPCM_DEVICE_GID,
  ...
  APP_USERS = {
    ...
    { name = IPMI_USER_NAME, uid = IPMI_USER_UID, gids = { IPMI_USER_GID, APPS_USER_GID, TPCM_DEVICE_GID } }, -- ipmi
    ...
    { name = TSB_USER_NAME, uid = TSB_USER_UID, gids = { TSB_USER_GID, TPCM_DEVICE_GID, APPS_USER_GID } } -- tsb_user
  },
  ...
  APP_GID_NAME_MAP = {
    ...
    [TSB_USER_GID] = TSB_USER_NAME,
    [TPCM_DEVICE_GID] = TPCM_DEVICE_GROUP_NAME,
