    ...
    ['mdb_method_configs'] = {
        ['bmc.kepler.AccountService'] = {
            ['ImportWeakPasswordDictionary'] = {
                ...
                ['rsp'] = {
                    {['baseType'] = 'U32', ['description'] = '仅远程上传涉及，任务id', ['param'] = 'TaskId'}
                },
                ['description'] = '导入弱口令字典'
            },
            ...
            ['GetRequestedPublicKey'] = {
                ...
                ['rsp'] = {{['baseType'] = 'String', ['description'] = '公钥字符串', ['param'] = 'PublicKey'}},
        ...
        ['bmc.kepler.AccountService.ManagerAccounts'] = {
            ['New'] = {
                ...
                ['req'] = {
                    ...
                    {['baseType'] = 'U8[]', ['maxLength'] = 32, ['param'] = 'Password'},
    ...
    ['mdb_method_configs'] = {
        ['bmc.kepler.AccountService.ManagerAccount'] = {
            ...
            ['ImportSSHPublicKey'] = {
                ...
                ['privilege'] = {'ConfigureSelf'},
                ['req'] = {
                    {['baseType'] = 'String', ['description'] = 'Content类型：URI/Text', ['param'] = 'Type'}, {
                        ['baseType'] = 'String',
            ...
            ['SetLastLogin'] = {
                ...
                ['privilege'] = {'ConfigureSelf'},
                ['req'] = {
                    {['baseType'] = 'String', ['description'] = '上次登录IP', ['param'] = 'Ip'},
                    {['baseType'] = 'String', ['description'] = '上次登录接口', ['param'] = 'Interface'}
                },
                ['rsp'] = {{['baseType'] = 'U8', ['description'] = '处理结果', ['param'] = 'Result'}},
        ...
        ['bmc.kepler.AccountService.ManagerAccount.SnmpUser'] = {
            ...
            ['SetEncryptionProtocol'] = {
                ...
                ['privilege'] = {'ConfigureSelf'},
                ['req'] = {
                    {['baseType'] = 'U8', ['description'] = 'SNMP加密算法', ['param'] = 'SNMPEncryptionProtocol'}
                },
                ['rsp'] = {},
            ...
            ['GetSnmpKeys'] = {
                ...
                ['req'] = {},
                ['rsp'] = {
                    {['baseType'] = 'String', ['description'] = 'SNMP鉴权密码 Ku', ['param'] = 'AuthenticationKey'},
                    {['baseType'] = 'String', ['description'] = 'SNMP加密密码 Ku', ['param'] = 'EncryptionKey'}
                },
...
local Roles = {
    ...
    ['prop_configs'] = {
        ['Id'] = {
            ...
            ['primaryKey'] = true,
            ['usage'] = {'PoweroffPer'},
            ['description'] = '持久化主键,无实际作用,Roles仅有一条数据',
    ...
    ['mdb_method_configs'] = {
        ['bmc.kepler.AccountService.Roles'] = {
            ['New'] = {
                ['initiator'] = true,
                ['req'] = {
                    {['baseType'] = 'U8', ['description'] = '角色Id', ['param'] = 'RoleId'},
                    {
                        ['baseType'] = 'String[]',
                        ['description'] = '角色标准权限',
                        ['param'] = 'AssignedPrivileges'
                    }, {['baseType'] = 'String[]', ['description'] = '角色Oem权限', ['param'] = 'OemPrivileges'}
                },
                ['rsp'] = {},
                ['description'] = '新增角色',
                ['privilege'] = {'UserMgmt'}
    ...
    ['mdb_method_configs'] = {
        ['bmc.kepler.AccountService.LocalAccountAuthN'] = {
            ...
            ['VncAuthenticate'] = {
                ...
                ['privilege'] = {'ReadOnly'},
                ['req'] = {
                    {['baseType'] = 'String', ['description'] = '密文', ['param'] = 'CipherText'},
                    {['baseType'] = 'String', ['description'] = '挑战码', ['param'] = 'AuthChallenge'}
                },
                ['rsp'] = {{['baseType'] = 'Dictionary', ['$ref'] = '#/defs/AccountData', ['param'] = 'AccountData'}},
                ['description'] = 'vnc用户认证'
            },
            ['GenRmcp20Code'] = {
                ['initiator'] = true,
                ['req'] = {
                    {['baseType'] = 'U8', ['description'] = '加密算法', ['param'] = 'AuthAlgo'},
                    {
                        ['baseType'] = 'String',
                        ['maxLength'] = 32,
                        ['minLength'] = 1,
                        ['description'] = '用户名',
                        ['param'] = 'UserName'
                    }, {['baseType'] = 'U32', ['description'] = '控制台端会话id', ['param'] = 'ConsoleSid'},
                    {['baseType'] = 'U32', ['description'] = '服务端系统身份id', ['param'] = 'ManagedSid'}, {
                        ['baseType'] = 'U8[]',
                        ['maxLength'] = 16,
                        ['minLength'] = 16,
                        ['description'] = '控制随机数',
                        ...
                        ['param'] = 'ManagedGuid'
                    }, {['baseType'] = 'U8', ['description'] = '角色权限', ['param'] = 'Role'},
                    {['baseType'] = 'String', ['description'] = 'IP地址', ['param'] = 'Ip'}
                },
                ['rsp'] = {
            ...
            ['GenRmcp15Code'] = {
                ...
                ['req'] = {
                    {['baseType'] = 'U8', ['description'] = '加密算法', ['param'] = 'AuthAlgo'}, {
                        ...
                        ['description'] = '有效负载',
                        ['param'] = 'PayLoad'
                    }, {['baseType'] = 'U8', ['description'] = '用户id', ['param'] = 'AccountId'},
                    {['baseType'] = 'U32', ['description'] = '会话id', ['param'] = 'SessionId'},
                    {['baseType'] = 'U32', ['description'] = 'RMCP会话的序列号', ['param'] = 'SessionSequence'}
                },
...
local PasswordPolicy = {
    ...
    ['default_props'] = {['AccountType'] = password_policy_class_types.AccountType.default[1]},
    ['mdb_prop_configs'] = {
    ...
    ['new_mdb_objects'] = mdb.new_objects_builder({
        ['bmc.kepler.AccountService.PasswordPolicy'] = {
            ['property_defaults'] = {['Policy'] = 1, ['Pattern'] = password_policy_intf_types.Pattern.default[1]},
            ['privileges'] = {
                ['path'] = privilege.ReadOnly,
                ['props'] = {
...
local LocalAccountPolicy = {
    ...
    ['mdb_classes'] = mdb.get_class_obj('/bmc/kepler/AccountService/AccountPolicies/Local'),
    ['new_mdb_objects'] = mdb.new_objects_builder({
        ['bmc.kepler.AccountService.AccountPolicy'] = {
            ['property_defaults'] = {
                ['NamePattern'] = '',
...
function M.ImplAccountServicePropertiesGetOptions(cb)
    class('AccountService')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
...
function M.ImplAccountServicePropertiesGetPropertiesByOptions(cb)
    class('AccountService')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
...
function M.ImplManagerAccountsPropertiesGetOptions(cb)
    class('ManagerAccounts')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplManagerAccountsPropertiesGetPropertiesByOptions(cb)
    class('ManagerAccounts')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplManagerAccountPropertiesGetOptions(cb)
    class('ManagerAccount')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplManagerAccountPropertiesGetPropertiesByOptions(cb)
    class('ManagerAccount')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplRulePropertiesGetOptions(cb)
    class('Rule')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplRulePropertiesGetPropertiesByOptions(cb)
    class('Rule')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
-- The callback needs to be registered during app initialization
function M.ImplRolesPropertiesGetOptions(cb)
    class('Roles')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
-- The callback needs to be registered during app initialization
function M.ImplRolesPropertiesGetPropertiesByOptions(cb)
    class('Roles')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplRolePropertiesGetOptions(cb)
    class('Role')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplRolePropertiesGetPropertiesByOptions(cb)
    class('Role')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplSnmpCommunityPropertiesGetOptions(cb)
    class('SnmpCommunity')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplSnmpCommunityPropertiesGetPropertiesByOptions(cb)
    class('SnmpCommunity')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplLocalAccountAuthNPropertiesGetOptions(cb)
    class('LocalAccountAuthN')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplLocalAccountAuthNPropertiesGetPropertiesByOptions(cb)
    class('LocalAccountAuthN')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplPasswordPolicyPropertiesGetOptions(cb)
    class('PasswordPolicy')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplPasswordPolicyPropertiesGetPropertiesByOptions(cb)
    class('PasswordPolicy')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplLocalAccountPolicyPropertiesGetOptions(cb)
    class('LocalAccountPolicy')['bmc.kepler.Object.Properties'].GetOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
...
function M.ImplLocalAccountPolicyPropertiesGetPropertiesByOptions(cb)
    class('LocalAccountPolicy')['bmc.kepler.Object.Properties'].GetPropertiesByOptions = function(obj, ctx, ...)
        local req = properties_intf_types.GetPropertiesByOptionsReq.new(...):validate(nil, nil, true)
        local rsp = properties_intf_types.GetPropertiesByOptionsRsp.new(cb(obj, ctx, req:unpack())):validate()
        return rsp:unpack(true)
    end
