...
TUserIpmiSetUserSNMPV3PrivacyPwdReq.__index =
    TUserIpmiSetUserSNMPV3PrivacyPwdReq
...
function TUserIpmiSetUserSNMPV3PrivacyPwdReq.new(ManufactureId, UserId,
                                                 Operation, PwdLength,
                                                 PasswordData)
...
TUserIpmiSetUserSNMPV3PrivacyPwdReq.from_obj =
    TUserIpmiSetUserSNMPV3PrivacyPwdReq_from_obj
...
TUserIpmiSetUserSNMPV3PrivacyPwdReq.struct = {
    ...
    {name = 'Operation', is_array = false, struct = nil},
    {name = 'PwdLength', is_array = false, struct = nil},
...
function TUserIpmiSetUserSNMPV3PrivacyPwdReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'UserId', self.UserId, "uint8", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'Operation', self.Operation, "uint8", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'PwdLength', self.PwdLength, "uint8", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'PasswordData', self.PasswordData, "string",
                      false, errs, need_convert)
...
function TUserIpmiSetUserSNMPV3PrivacyPwdReq:unpack(_)
    return self.ManufactureId, self.UserId, self.Operation, self.PwdLength,
           self.PasswordData
end

UserIpmiSetUserSNMPV3PrivacyPwd.UserIpmiSetUserSNMPV3PrivacyPwdReq =
    TUserIpmiSetUserSNMPV3PrivacyPwdReq
...
TUserIpmiSetUserSNMPV3PrivacyPwdRsp.__index =
    TUserIpmiSetUserSNMPV3PrivacyPwdRsp
...
function TUserIpmiSetUserSNMPV3PrivacyPwdRsp.new(CompletionCode, ManufactureId)
    return TUserIpmiSetUserSNMPV3PrivacyPwdRsp_from_obj({
...
TUserIpmiSetUserSNMPV3PrivacyPwdRsp.from_obj =
    TUserIpmiSetUserSNMPV3PrivacyPwdRsp_from_obj

TUserIpmiSetUserSNMPV3PrivacyPwdRsp.proto_property = {
...
UserIpmiSetUserSNMPV3PrivacyPwd.UserIpmiSetUserSNMPV3PrivacyPwdRsp =
    TUserIpmiSetUserSNMPV3PrivacyPwdRsp
