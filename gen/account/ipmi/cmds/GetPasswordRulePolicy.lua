...
function TGetPasswordRulePolicyReq.new(ManufactureId, AccountType)
    return TGetPasswordRulePolicyReq_from_obj({
...
function TGetPasswordRulePolicyReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TGetPasswordRulePolicyReq.proto_property,
                                 errs, need_convert)
    return self
end
...
function TGetPasswordRulePolicyRsp.new(CompletionCode, ManufactureId, Length,
                                       Data)
...
TGetPasswordRulePolicyRsp.proto_property = {
...
function TGetPasswordRulePolicyRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TGetPasswordRulePolicyRsp.proto_property,
                                 errs, need_convert)
    return self
end
