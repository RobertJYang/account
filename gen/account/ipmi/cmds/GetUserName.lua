...
function TGetUserNameReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TGetUserNameReq.proto_property, errs,
                                 need_convert)
    return self
end

function TGetUserNameReq:unpack(_) return self.UserId, self.Reserved end
...
function TGetUserNameRsp.new(CompletionCode, UserName)
    return TGetUserNameRsp_from_obj({
...
function TGetUserNameRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TGetUserNameRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TGetUserNameRsp:unpack(_) return self.CompletionCode, self.UserName end
