...
function TGetUserPasswordCompareInfoReq.new(ManufactureId)
    return TGetUserPasswordCompareInfoReq_from_obj({
...
TGetUserPasswordCompareInfoReq.from_obj =
    TGetUserPasswordCompareInfoReq_from_obj

TGetUserPasswordCompareInfoReq.proto_property = {'ManufactureId'}

TGetUserPasswordCompareInfoReq.default = {0}

TGetUserPasswordCompareInfoReq.struct = {
...
function TGetUserPasswordCompareInfoReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self,
                                 TGetUserPasswordCompareInfoReq.proto_property,
                                 errs, need_convert)
    return self
end

function TGetUserPasswordCompareInfoReq:unpack(_) return self.ManufactureId end

GetUserPasswordCompareInfo.GetUserPasswordCompareInfoReq =
    TGetUserPasswordCompareInfoReq
...
function TGetUserPasswordCompareInfoRsp.new(CompletionCode, ManufactureId,
                                            CompareEnabled, CompareLength)
...
TGetUserPasswordCompareInfoRsp.from_obj =
    TGetUserPasswordCompareInfoRsp_from_obj

TGetUserPasswordCompareInfoRsp.proto_property = {
    'CompletionCode', 'ManufactureId', 'CompareEnabled', 'CompareLength'
}
...
function TGetUserPasswordCompareInfoRsp:unpack(_)
    return self.CompletionCode, self.ManufactureId, self.CompareEnabled,
           self.CompareLength
end

GetUserPasswordCompareInfo.GetUserPasswordCompareInfoRsp =
    TGetUserPasswordCompareInfoRsp
