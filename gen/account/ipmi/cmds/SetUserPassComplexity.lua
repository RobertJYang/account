...
function TSetUserPassComplexityReq.new(ManufactureId, Control)
    return TSetUserPassComplexityReq_from_obj({
...
function TSetUserPassComplexityReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetUserPassComplexityReq.proto_property,
                                 errs, need_convert)
    return self
end
...
function TSetUserPassComplexityRsp.new(CompletionCode, ManufactureId)
    return TSetUserPassComplexityRsp_from_obj({
...
function TSetUserPassComplexityRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetUserPassComplexityRsp.proto_property,
                                 errs, need_convert)
    return self
end
