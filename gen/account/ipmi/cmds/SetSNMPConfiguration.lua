...
function TSetSNMPConfigurationReq.new(ManufactureId, SNMPParameter, BlockSelector, SubBlockSelector, Length, Data)
...
TSetSNMPConfigurationReq.proto_property = {
    'ManufactureId', 'SNMPParameter', 'BlockSelector', 'SubBlockSelector', 'Length', 'Data'
}
...
TSetSNMPConfigurationReq.struct = {
    ...
    {name = 'SubBlockSelector', is_array = false, struct = nil}, {name = 'Length', is_array = false, struct = nil},
...
function TSetSNMPConfigurationReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetSNMPConfigurationReq.proto_property, errs, need_convert)
    return self
end

function TSetSNMPConfigurationReq:unpack(_)
    return self.ManufactureId, self.SNMPParameter, self.BlockSelector, self.SubBlockSelector, self.Length, self.Data
end
...
function TSetSNMPConfigurationRsp.new(CompletionCode, ManufactureId)
    return TSetSNMPConfigurationRsp_from_obj({CompletionCode = CompletionCode, ManufactureId = ManufactureId})
end
...
function TSetSNMPConfigurationRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetSNMPConfigurationRsp.proto_property, errs, need_convert)
    return self
end
