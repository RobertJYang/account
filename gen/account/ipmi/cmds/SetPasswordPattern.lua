...
function TSetPasswordPatternReq.new(ManufactureId, AccountType, Reserved,
                                    Length, Data)
...
TSetPasswordPatternReq.proto_property = {
    'ManufactureId', 'AccountType', 'Reserved', 'Length', 'Data'
}
...
TSetPasswordPatternReq.struct = {
    ...
    {name = 'AccountType', is_array = false, struct = nil},
...
function TSetPasswordPatternReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'AccountType', self.AccountType, "uint8", false,
                      errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetPasswordPatternReq.proto_property,
                                 errs, need_convert)
    return self
end

function TSetPasswordPatternReq:unpack(_)
    return self.ManufactureId, self.AccountType, self.Reserved, self.Length,
           self.Data
end
...
function TSetPasswordPatternRsp.new(CompletionCode, ManufactureId)
    return TSetPasswordPatternRsp_from_obj({
...
function TSetPasswordPatternRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetPasswordPatternRsp.proto_property,
                                 errs, need_convert)
    return self
end
