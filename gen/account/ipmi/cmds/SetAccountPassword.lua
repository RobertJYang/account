...
function TSetAccountPasswordReq.new(UserId, Reserved1, PasswordSize, Reserved2,
                                    PasswordData)
...
TSetAccountPasswordReq.proto_property = {
    'UserId', 'Reserved1', 'PasswordSize', 'Reserved2', 'PasswordData'
}
...
TSetAccountPasswordReq.struct = {
    ...
    {name = 'PasswordSize', is_array = false, struct = nil},
...
function TSetAccountPasswordReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'Reserved1', self.Reserved1, "uint8", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'PasswordSize', self.PasswordSize, "uint8",
    ...
    validate.CheckUnknowProperty(self, TSetAccountPasswordReq.proto_property,
                                 errs, need_convert)
    return self
end

function TSetAccountPasswordReq:unpack(_)
    return self.UserId, self.Reserved1, self.PasswordSize, self.Reserved2,
           self.PasswordData
end
...
function TSetAccountPasswordRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetAccountPasswordRsp.proto_property,
                                 errs, need_convert)
    return self
end

function TSetAccountPasswordRsp:unpack(_) return self.CompletionCode end
