...
function TEnableAccountReq.new(UserId, Reserved1, PasswordSize, Reserved2,
                               PasswordData)
...
TEnableAccountReq.proto_property = {
...
function TEnableAccountReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TEnableAccountReq.proto_property, errs,
                                 need_convert)
    return self
end
...
function TEnableAccountRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TEnableAccountRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TEnableAccountRsp:unpack(_) return self.CompletionCode end
