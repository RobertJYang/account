...
function account_service:ImplAccountPolicyPropertiesGetOptions(cb)
    model.ImplAccountPolicyPropertiesGetOptions(cb)
end

function account_service:ImplAccountPolicyPropertiesGetPropertiesByOptions(cb)
...
function account_service:init()
    ...
    object_manage.create_object('LocalAccountAuthN', '/bmc/kepler/AccountService/LocalAccountAuthN',
        '/bmc/kepler/AccountService/LocalAccountAuthN').ObjectName = 'LocalAccountAuthN_0'
end
