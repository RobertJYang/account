...
local LocalAccountPolicy = mdb.register_object('/bmc/kepler/AccountService/AccountPolicies/Local', {
...
function account_service:ImplRolesPropertiesGetOptions(cb)
    model.ImplRolesPropertiesGetOptions(cb)
end

function account_service:ImplRolesPropertiesGetPropertiesByOptions(cb)
    model.ImplRolesPropertiesGetPropertiesByOptions(cb)
end
...
function account_service:ImplLocalAccountAuthNPropertiesGetPropertiesByOptions(cb)
    model.ImplLocalAccountAuthNPropertiesGetPropertiesByOptions(cb)
end
...
function account_service:ImplLocalAccountPolicyPropertiesGetPropertiesByOptions(cb)
    model.ImplLocalAccountPolicyPropertiesGetPropertiesByOptions(cb)
end
...
function account_service:init()
    ...
    object_manage.create_object('LocalAccountPolicy', '/bmc/kepler/AccountService/AccountPolicies/Local',
        '/bmc/kepler/AccountService/AccountPolicies/Local', function(obj)
            obj.ObjectName = 'LocalAccountPolicy_0'
        end)
end
