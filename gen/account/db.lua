...
---@field AccountPolicy AccountPolicyTable
...
function AccountDBDatabase.new(path, datas)
    ...
    obj.AccountService = db:Table('t_account_service', {
        ...
        PasswordComplexityEnable = Col.BooleandField():cid(7):persistence_key('protect_power_off'):null()
            :default(true),
    ...
    obj.AccountPolicy = db:Table('t_account_policy', {
