...
TUserNamePasswordPrefixCompareLength.__index =
    TUserNamePasswordPrefixCompareLength
...
function TUserNamePasswordPrefixCompareLength.new(
    UserNamePasswordPrefixCompareLength)
    return TUserNamePasswordPrefixCompareLength_from_obj({
        UserNamePasswordPrefixCompareLength = UserNamePasswordPrefixCompareLength or
            4
    })
end
...
function TUserNamePasswordPrefixCompareLength:init_from_obj(obj)
    self.UserNamePasswordPrefixCompareLength =
        obj.UserNamePasswordPrefixCompareLength or 4
end
...
TUserNamePasswordPrefixCompareLength.from_obj =
    TUserNamePasswordPrefixCompareLength_from_obj

TUserNamePasswordPrefixCompareLength.proto_property = {
    'UserNamePasswordPrefixCompareLength'
}
...
TUserNamePasswordPrefixCompareLength.struct = {
    {
        name = 'UserNamePasswordPrefixCompareLength',
        is_array = false,
        struct = nil
    }
}

function TUserNamePasswordPrefixCompareLength:validate(prefix, errs,
                                                       need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'UserNamePasswordPrefixCompareLength',
                      self.UserNamePasswordPrefixCompareLength, "uint8", false,
                      errs, need_convert)

    if self.UserNamePasswordPrefixCompareLength ~= nil then
        validate.ranges(prefix .. 'UserNamePasswordPrefixCompareLength',
                        self.UserNamePasswordPrefixCompareLength, 4, 20, errs,
                        need_convert)
    end
...
AccountService.UserNamePasswordPrefixCompareLength =
    TUserNamePasswordPrefixCompareLength
...
TUserNamePasswordPrefixCompareEnabled.__index =
    TUserNamePasswordPrefixCompareEnabled
...
function TUserNamePasswordPrefixCompareEnabled.new(
    UserNamePasswordPrefixCompareEnabled)
    return TUserNamePasswordPrefixCompareEnabled_from_obj({
        UserNamePasswordPrefixCompareEnabled = UserNamePasswordPrefixCompareEnabled or
            false
    })
end
...
function TUserNamePasswordPrefixCompareEnabled:init_from_obj(obj)
    self.UserNamePasswordPrefixCompareEnabled =
        obj.UserNamePasswordPrefixCompareEnabled or false
end
...
TUserNamePasswordPrefixCompareEnabled.from_obj =
    TUserNamePasswordPrefixCompareEnabled_from_obj

TUserNamePasswordPrefixCompareEnabled.proto_property = {
    'UserNamePasswordPrefixCompareEnabled'
}
...
TUserNamePasswordPrefixCompareEnabled.struct = {
    {
        name = 'UserNamePasswordPrefixCompareEnabled',
        is_array = false,
        struct = nil
    }
}

function TUserNamePasswordPrefixCompareEnabled:validate(prefix, errs,
                                                        need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'UserNamePasswordPrefixCompareEnabled',
                      self.UserNamePasswordPrefixCompareEnabled, "bool", false,
                      errs, need_convert)
...
AccountService.UserNamePasswordPrefixCompareEnabled =
    TUserNamePasswordPrefixCompareEnabled
...
function TSNMPv3TrapAccountLimitPolicy.new(SNMPv3TrapAccountLimitPolicy)
    return TSNMPv3TrapAccountLimitPolicy_from_obj({
        SNMPv3TrapAccountLimitPolicy = SNMPv3TrapAccountLimitPolicy or 2
    })
end
...
TSNMPv3TrapAccountLimitPolicy.struct = {
    {name = 'SNMPv3TrapAccountLimitPolicy', is_array = false, struct = nil}
}

function TSNMPv3TrapAccountLimitPolicy:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'SNMPv3TrapAccountLimitPolicy',
                      self.SNMPv3TrapAccountLimitPolicy, "uint8", false, errs,
                      need_convert)

    TSNMPv3TrapAccountLimitPolicy:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self,
                                 TSNMPv3TrapAccountLimitPolicy.proto_property,
                                 errs, need_convert)
    return self
end
...
function TOSAdministratorPrivilegeEnabled.new(OSAdministratorPrivilegeEnabled)
    return TOSAdministratorPrivilegeEnabled_from_obj({
        OSAdministratorPrivilegeEnabled = OSAdministratorPrivilegeEnabled == nil and
            true or OSAdministratorPrivilegeEnabled
    })
end
---@param obj AccountService.OSAdministratorPrivilegeEnabled
function TOSAdministratorPrivilegeEnabled:init_from_obj(obj)
    self.OSAdministratorPrivilegeEnabled =
        obj.OSAdministratorPrivilegeEnabled == nil and true or
...
TOSAdministratorPrivilegeEnabled.from_obj =
    TOSAdministratorPrivilegeEnabled_from_obj

TOSAdministratorPrivilegeEnabled.proto_property = {
    'OSAdministratorPrivilegeEnabled'
}

TOSAdministratorPrivilegeEnabled.default = {false}

TOSAdministratorPrivilegeEnabled.struct = {
    {name = 'OSAdministratorPrivilegeEnabled', is_array = false, struct = nil}
}

function TOSAdministratorPrivilegeEnabled:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'OSAdministratorPrivilegeEnabled',
                      self.OSAdministratorPrivilegeEnabled, "bool", false, errs,
                      need_convert)
...
AccountService.OSAdministratorPrivilegeEnabled =
    TOSAdministratorPrivilegeEnabled
...
function THostUserManagementEnabled.new(HostUserManagementEnabled)
    return THostUserManagementEnabled_from_obj({
        HostUserManagementEnabled = HostUserManagementEnabled == nil and true or
...
function THostUserManagementEnabled:init_from_obj(obj)
    self.HostUserManagementEnabled = obj.HostUserManagementEnabled == nil and
                                         true or obj.HostUserManagementEnabled
end
...
THostUserManagementEnabled.struct = {
    {name = 'HostUserManagementEnabled', is_array = false, struct = nil}
}

function THostUserManagementEnabled:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'HostUserManagementEnabled',
                      self.HostUserManagementEnabled, "bool", false, errs,
                      need_convert)

    THostUserManagementEnabled:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self,
                                 THostUserManagementEnabled.proto_property,
                                 errs, need_convert)
    return self
end
...
function THistoryPasswordCount.new(HistoryPasswordCount)
    return THistoryPasswordCount_from_obj({
        HistoryPasswordCount = HistoryPasswordCount or 5
    })
end
...
THistoryPasswordCount.struct = {
    {name = 'HistoryPasswordCount', is_array = false, struct = nil}
}

function THistoryPasswordCount:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'HistoryPasswordCount',
                      self.HistoryPasswordCount, "uint8", false, errs,
                      need_convert)

    if self.HistoryPasswordCount ~= nil then
        validate.ranges(prefix .. 'HistoryPasswordCount',
                        self.HistoryPasswordCount, 0, 5, errs, need_convert)
    end

    THistoryPasswordCount:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, THistoryPasswordCount.proto_property,
                                 errs, need_convert)
    return self
end

function THistoryPasswordCount:unpack(_) return self.HistoryPasswordCount end
...
function TWeakPasswordDictionaryEnabled.new(WeakPasswordDictionaryEnabled)
    return TWeakPasswordDictionaryEnabled_from_obj({
        WeakPasswordDictionaryEnabled = WeakPasswordDictionaryEnabled == nil and
            true or WeakPasswordDictionaryEnabled
    })
end
---@param obj AccountService.WeakPasswordDictionaryEnabled
function TWeakPasswordDictionaryEnabled:init_from_obj(obj)
    self.WeakPasswordDictionaryEnabled =
        obj.WeakPasswordDictionaryEnabled == nil and true or
...
TWeakPasswordDictionaryEnabled.from_obj =
    TWeakPasswordDictionaryEnabled_from_obj

TWeakPasswordDictionaryEnabled.proto_property = {
    'WeakPasswordDictionaryEnabled'
}

TWeakPasswordDictionaryEnabled.default = {false}

TWeakPasswordDictionaryEnabled.struct = {
    {name = 'WeakPasswordDictionaryEnabled', is_array = false, struct = nil}
}

function TWeakPasswordDictionaryEnabled:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'WeakPasswordDictionaryEnabled',
                      self.WeakPasswordDictionaryEnabled, "bool", false, errs,
                      need_convert)
...
function TInactiveDaysThreshold.new(InactiveDaysThreshold)
    return TInactiveDaysThreshold_from_obj({
        InactiveDaysThreshold = InactiveDaysThreshold or 0
    })
end
...
TInactiveDaysThreshold.struct = {
    {name = 'InactiveDaysThreshold', is_array = false, struct = nil}
}

function TInactiveDaysThreshold:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'InactiveDaysThreshold',
                      self.InactiveDaysThreshold, "uint32", false, errs,
                      need_convert)

    if self.InactiveDaysThreshold ~= nil then
        validate.ranges(prefix .. 'InactiveDaysThreshold',
                        self.InactiveDaysThreshold, 0, 365, errs, need_convert)
    end

    TInactiveDaysThreshold:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TInactiveDaysThreshold.proto_property,
                                 errs, need_convert)
    return self
end

function TInactiveDaysThreshold:unpack(_) return self.InactiveDaysThreshold end
...
function TSNMPv3TrapAccountId.new(SNMPv3TrapAccountId)
    return TSNMPv3TrapAccountId_from_obj({
        SNMPv3TrapAccountId = SNMPv3TrapAccountId or 2
    })
end
...
TSNMPv3TrapAccountId.struct = {
    {name = 'SNMPv3TrapAccountId', is_array = false, struct = nil}
}

function TSNMPv3TrapAccountId:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'SNMPv3TrapAccountId', self.SNMPv3TrapAccountId,
                      "uint8", false, errs, need_convert)

    if self.SNMPv3TrapAccountId ~= nil then
        validate.ranges(prefix .. 'SNMPv3TrapAccountId',
                        self.SNMPv3TrapAccountId, 0, 17, errs, need_convert)
    end

    TSNMPv3TrapAccountId:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TSNMPv3TrapAccountId.proto_property,
                                 errs, need_convert)
    return self
end

function TSNMPv3TrapAccountId:unpack(_) return self.SNMPv3TrapAccountId end
...
function TEmergencyLoginAccountId.new(EmergencyLoginAccountId)
    return TEmergencyLoginAccountId_from_obj({
        EmergencyLoginAccountId = EmergencyLoginAccountId or 0
    })
end
...
TEmergencyLoginAccountId.struct = {
    {name = 'EmergencyLoginAccountId', is_array = false, struct = nil}
}

function TEmergencyLoginAccountId:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'EmergencyLoginAccountId',
                      self.EmergencyLoginAccountId, "uint8", false, errs,
                      need_convert)

    if self.EmergencyLoginAccountId ~= nil then
        validate.ranges(prefix .. 'EmergencyLoginAccountId',
                        self.EmergencyLoginAccountId, 0, 17, errs, need_convert)
    end

    TEmergencyLoginAccountId:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TEmergencyLoginAccountId.proto_property,
                                 errs, need_convert)
    return self
end

function TEmergencyLoginAccountId:unpack(_) return self.EmergencyLoginAccountId end
...
function TMaxPasswordValidDays.new(MaxPasswordValidDays)
    return TMaxPasswordValidDays_from_obj({
        MaxPasswordValidDays = MaxPasswordValidDays or 0
    })
end
...
TMaxPasswordValidDays.struct = {
    {name = 'MaxPasswordValidDays', is_array = false, struct = nil}
}

function TMaxPasswordValidDays:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'MaxPasswordValidDays',
                      self.MaxPasswordValidDays, "uint32", false, errs,
                      need_convert)

    if self.MaxPasswordValidDays ~= nil then
        validate.ranges(prefix .. 'MaxPasswordValidDays',
                        self.MaxPasswordValidDays, 0, 365, errs, need_convert)
    end

    TMaxPasswordValidDays:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TMaxPasswordValidDays.proto_property,
                                 errs, need_convert)
    return self
end

function TMaxPasswordValidDays:unpack(_) return self.MaxPasswordValidDays end
...
function TMinPasswordValidDays.new(MinPasswordValidDays)
    return TMinPasswordValidDays_from_obj({
        MinPasswordValidDays = MinPasswordValidDays or 0
    })
end
...
TMinPasswordValidDays.struct = {
    {name = 'MinPasswordValidDays', is_array = false, struct = nil}
}

function TMinPasswordValidDays:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'MinPasswordValidDays',
                      self.MinPasswordValidDays, "uint32", false, errs,
                      need_convert)

    if self.MinPasswordValidDays ~= nil then
        validate.ranges(prefix .. 'MinPasswordValidDays',
                        self.MinPasswordValidDays, 0, 365, errs, need_convert)
    end

    TMinPasswordValidDays:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TMinPasswordValidDays.proto_property,
                                 errs, need_convert)
    return self
end

function TMinPasswordValidDays:unpack(_) return self.MinPasswordValidDays end
...
TInitialAccountPrivilegeRestrictEnabled.__index =
    TInitialAccountPrivilegeRestrictEnabled
...
function TInitialAccountPrivilegeRestrictEnabled.new(
    InitialAccountPrivilegeRestrictEnabled)
    return TInitialAccountPrivilegeRestrictEnabled_from_obj({
        InitialAccountPrivilegeRestrictEnabled = InitialAccountPrivilegeRestrictEnabled or
            false
    })
end
...
function TInitialAccountPrivilegeRestrictEnabled:init_from_obj(obj)
    self.InitialAccountPrivilegeRestrictEnabled =
        obj.InitialAccountPrivilegeRestrictEnabled or false
end
...
TInitialAccountPrivilegeRestrictEnabled.from_obj =
    TInitialAccountPrivilegeRestrictEnabled_from_obj

TInitialAccountPrivilegeRestrictEnabled.proto_property = {
    'InitialAccountPrivilegeRestrictEnabled'
}
...
TInitialAccountPrivilegeRestrictEnabled.struct = {
    {
        name = 'InitialAccountPrivilegeRestrictEnabled',
        is_array = false,
        struct = nil
    }
}

function TInitialAccountPrivilegeRestrictEnabled:validate(prefix, errs,
                                                          need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'InitialAccountPrivilegeRestrictEnabled',
                      self.InitialAccountPrivilegeRestrictEnabled, "bool",
...
AccountService.InitialAccountPrivilegeRestrictEnabled =
    TInitialAccountPrivilegeRestrictEnabled
...
function TInitialPasswordNeedModify.new(InitialPasswordNeedModify)
    return TInitialPasswordNeedModify_from_obj({
        InitialPasswordNeedModify = InitialPasswordNeedModify == nil and true or
...
function TInitialPasswordNeedModify:init_from_obj(obj)
    self.InitialPasswordNeedModify = obj.InitialPasswordNeedModify == nil and
                                         true or obj.InitialPasswordNeedModify
end
...
TInitialPasswordNeedModify.struct = {
    {name = 'InitialPasswordNeedModify', is_array = false, struct = nil}
}

function TInitialPasswordNeedModify:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'InitialPasswordNeedModify',
                      self.InitialPasswordNeedModify, "bool", false, errs,
                      need_convert)

    TInitialPasswordNeedModify:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self,
                                 TInitialPasswordNeedModify.proto_property,
                                 errs, need_convert)
    return self
end
...
function TInitialPasswordPromptEnable.new(InitialPasswordPromptEnable)
    return TInitialPasswordPromptEnable_from_obj({
        InitialPasswordPromptEnable = InitialPasswordPromptEnable == nil and
            true or InitialPasswordPromptEnable
    })
end
---@param obj AccountService.InitialPasswordPromptEnable
function TInitialPasswordPromptEnable:init_from_obj(obj)
    self.InitialPasswordPromptEnable =
        obj.InitialPasswordPromptEnable == nil and true or
...
TInitialPasswordPromptEnable.struct = {
    {name = 'InitialPasswordPromptEnable', is_array = false, struct = nil}
}

function TInitialPasswordPromptEnable:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'InitialPasswordPromptEnable',
                      self.InitialPasswordPromptEnable, "bool", false, errs,
                      need_convert)

    TInitialPasswordPromptEnable:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self,
                                 TInitialPasswordPromptEnable.proto_property,
                                 errs, need_convert)
    return self
end
...
function TPasswordComplexityEnable.new(PasswordComplexityEnable)
    return TPasswordComplexityEnable_from_obj({
        PasswordComplexityEnable = PasswordComplexityEnable == nil and true or
...
function TPasswordComplexityEnable:init_from_obj(obj)
    self.PasswordComplexityEnable =
        obj.PasswordComplexityEnable == nil and true or
            obj.PasswordComplexityEnable
end
...
TPasswordComplexityEnable.struct = {
    {name = 'PasswordComplexityEnable', is_array = false, struct = nil}
}

function TPasswordComplexityEnable:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'PasswordComplexityEnable',
                      self.PasswordComplexityEnable, "bool", false, errs,
                      need_convert)

    TPasswordComplexityEnable:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TPasswordComplexityEnable.proto_property,
                                 errs, need_convert)
    return self
end

function TPasswordComplexityEnable:unpack(_) return
    self.PasswordComplexityEnable end
...
function TServiceEnabled.new(ServiceEnabled)
    return TServiceEnabled_from_obj({
        ServiceEnabled = ServiceEnabled == nil and true or ServiceEnabled
    })
end
---@param obj AccountService.ServiceEnabled
function TServiceEnabled:init_from_obj(obj)
    self.ServiceEnabled = obj.ServiceEnabled == nil and true or
                              obj.ServiceEnabled
end
...
TServiceEnabled.struct = {
    {name = 'ServiceEnabled', is_array = false, struct = nil}
}

function TServiceEnabled:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'ServiceEnabled', self.ServiceEnabled, "bool",
                      false, errs, need_convert)

    TServiceEnabled:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TServiceEnabled.proto_property, errs,
                                 need_convert)
    return self
end

function TServiceEnabled:unpack(_) return self.ServiceEnabled end
...
function TMinPasswordLength.new(MinPasswordLength)
    return TMinPasswordLength_from_obj({
        MinPasswordLength = MinPasswordLength or 8
    })
end
...
TMinPasswordLength.struct = {
    {name = 'MinPasswordLength', is_array = false, struct = nil}
}

function TMinPasswordLength:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'MinPasswordLength', self.MinPasswordLength,
                      "int32", false, errs, need_convert)

    if self.MinPasswordLength ~= nil then
        validate.ranges(prefix .. 'MinPasswordLength', self.MinPasswordLength,
                        8, 20, errs, need_convert)
    end

    TMinPasswordLength:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TMinPasswordLength.proto_property, errs,
                                 need_convert)
    return self
end

function TMinPasswordLength:unpack(_) return self.MinPasswordLength end
...
function TMaxPasswordLength.new(MaxPasswordLength)
    return TMaxPasswordLength_from_obj({
        MaxPasswordLength = MaxPasswordLength or 20
    })
end
...
TMaxPasswordLength.struct = {
    {name = 'MaxPasswordLength', is_array = false, struct = nil}
}

function TMaxPasswordLength:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'MaxPasswordLength', self.MaxPasswordLength,
                      "int32", true, errs, need_convert)

    TMaxPasswordLength:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TMaxPasswordLength.proto_property, errs,
                                 need_convert)
    return self
end

function TMaxPasswordLength:unpack(_) return self.MaxPasswordLength end
...
function TAuthFailureLoggingThreshold.new(AuthFailureLoggingThreshold)
    return TAuthFailureLoggingThreshold_from_obj({
        AuthFailureLoggingThreshold = AuthFailureLoggingThreshold or 0
    })
end
...
TAuthFailureLoggingThreshold.struct = {
    {name = 'AuthFailureLoggingThreshold', is_array = false, struct = nil}
}

function TAuthFailureLoggingThreshold:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'AuthFailureLoggingThreshold',
                      self.AuthFailureLoggingThreshold, "int32", false, errs,
                      need_convert)

    TAuthFailureLoggingThreshold:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self,
                                 TAuthFailureLoggingThreshold.proto_property,
                                 errs, need_convert)
    return self
end
...
TAccountLockoutCounterResetEnabled.from_obj =
    TAccountLockoutCounterResetEnabled_from_obj

TAccountLockoutCounterResetEnabled.proto_property = {
    'AccountLockoutCounterResetEnabled'
}
...
function TAccountLockoutCounterResetEnabled:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'AccountLockoutCounterResetEnabled',
                      self.AccountLockoutCounterResetEnabled, "bool", false,
                      errs, need_convert)
...
AccountService.AccountLockoutCounterResetEnabled =
    TAccountLockoutCounterResetEnabled
...
function TAccountLockoutCounterResetAfter:init_from_obj(obj)
    self.AccountLockoutCounterResetAfter =
        obj.AccountLockoutCounterResetAfter or 0
end
...
TAccountLockoutCounterResetAfter.from_obj =
    TAccountLockoutCounterResetAfter_from_obj

TAccountLockoutCounterResetAfter.proto_property = {
    'AccountLockoutCounterResetAfter'
}

TAccountLockoutCounterResetAfter.default = {0}

TAccountLockoutCounterResetAfter.struct = {
    {name = 'AccountLockoutCounterResetAfter', is_array = false, struct = nil}
}

function TAccountLockoutCounterResetAfter:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'AccountLockoutCounterResetAfter',
                      self.AccountLockoutCounterResetAfter, "int32", false,
                      errs, need_convert)
...
AccountService.AccountLockoutCounterResetAfter =
    TAccountLockoutCounterResetAfter
...
function TRecoverAccountRsp.new() return TRecoverAccountRsp_from_obj({}) end
---@param obj AccountService.RecoverAccountRsp
function TRecoverAccountRsp:init_from_obj(obj) end
...
function TRecoverAccountRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TRecoverAccountRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TRecoverAccountRsp:unpack(_) end
...
TRecoverAccountReq.struct = {
    ...
    {name = 'Policy', is_array = false, struct = nil}
}

function TRecoverAccountReq:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'AccountId', self.AccountId, "uint8", false,
                      errs, need_convert)
    ...
    if self.Policy ~= nil then
        validate.ranges(prefix .. 'Policy', self.Policy, 0, 1, errs,
                        need_convert)
    end

    TRecoverAccountReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TRecoverAccountReq.proto_property, errs,
                                 need_convert)
    return self
end

function TRecoverAccountReq:unpack(_) return self.AccountId, self.Policy end
...
TGetRequestedPublicKeyRsp.struct = {
    {name = 'PublicKey', is_array = false, struct = nil}
}

function TGetRequestedPublicKeyRsp:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'PublicKey', self.PublicKey, "string", false,
                      errs, need_convert)

    TGetRequestedPublicKeyRsp:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TGetRequestedPublicKeyRsp.proto_property,
                                 errs, need_convert)
    return self
end

function TGetRequestedPublicKeyRsp:unpack(_) return self.PublicKey end
...
function TGetRequestedPublicKeyReq.new(PublicKeyUsageType)
    return TGetRequestedPublicKeyReq_from_obj({
        PublicKeyUsageType = PublicKeyUsageType
    })
end
...
TGetRequestedPublicKeyReq.struct = {
    {name = 'PublicKeyUsageType', is_array = false, struct = nil}
}

function TGetRequestedPublicKeyReq:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'PublicKeyUsageType', self.PublicKeyUsageType,
                      "uint8", false, errs, need_convert)

    TGetRequestedPublicKeyReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TGetRequestedPublicKeyReq.proto_property,
                                 errs, need_convert)
    return self
end

function TGetRequestedPublicKeyReq:unpack(_) return self.PublicKeyUsageType end
...
TExportWeakPasswordDictionaryRsp.from_obj =
    TExportWeakPasswordDictionaryRsp_from_obj
...
function TExportWeakPasswordDictionaryRsp:unpack(_) return self.TaskId end

AccountService.ExportWeakPasswordDictionaryRsp =
    TExportWeakPasswordDictionaryRsp
...
function TExportWeakPasswordDictionaryReq:init_from_obj(obj) self.Path =
    obj.Path end
...
TExportWeakPasswordDictionaryReq.from_obj =
    TExportWeakPasswordDictionaryReq_from_obj

TExportWeakPasswordDictionaryReq.proto_property = {'Path'}

TExportWeakPasswordDictionaryReq.default = {''}

TExportWeakPasswordDictionaryReq.struct = {
...
function TExportWeakPasswordDictionaryReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'Path', self.Path, "string", false, errs,
                      need_convert)

    TExportWeakPasswordDictionaryReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self,
                                 TExportWeakPasswordDictionaryReq.proto_property,
                                 errs, need_convert)
    return self
end

function TExportWeakPasswordDictionaryReq:unpack(_) return self.Path end

AccountService.ExportWeakPasswordDictionaryReq =
    TExportWeakPasswordDictionaryReq
...
TImportWeakPasswordDictionaryRsp.from_obj =
    TImportWeakPasswordDictionaryRsp_from_obj
...
function TImportWeakPasswordDictionaryRsp:unpack(_) return self.TaskId end

AccountService.ImportWeakPasswordDictionaryRsp =
    TImportWeakPasswordDictionaryRsp
...
function TImportWeakPasswordDictionaryReq:init_from_obj(obj) self.Path =
    obj.Path end
...
TImportWeakPasswordDictionaryReq.from_obj =
    TImportWeakPasswordDictionaryReq_from_obj

TImportWeakPasswordDictionaryReq.proto_property = {'Path'}

TImportWeakPasswordDictionaryReq.default = {''}

TImportWeakPasswordDictionaryReq.struct = {
    {name = 'Path', is_array = false, struct = nil}
}
...
function TImportWeakPasswordDictionaryReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self,
                                 TImportWeakPasswordDictionaryReq.proto_property,
                                 errs, need_convert)
    return self
end

function TImportWeakPasswordDictionaryReq:unpack(_) return self.Path end

AccountService.ImportWeakPasswordDictionaryReq =
    TImportWeakPasswordDictionaryReq
...
AccountService.interface = mdb.register_interface('bmc.kepler.AccountService',
    ...
    InitialAccountPrivilegeRestrictEnabled = {
        'b', {'EMIT_CHANGE'}, false, false, false
    },
    ...
    UserNamePasswordPrefixCompareLength = {
        'y', {'EMIT_CHANGE'}, false, 4, false
    }
}, {
    ImportWeakPasswordDictionary = {
        'a{ss}s', 'u', TImportWeakPasswordDictionaryReq,
        TImportWeakPasswordDictionaryRsp
    },
    ExportWeakPasswordDictionary = {
        'a{ss}s', 'u', TExportWeakPasswordDictionaryReq,
        TExportWeakPasswordDictionaryRsp
    },
    GetRequestedPublicKey = {
        'a{ss}y', 's', TGetRequestedPublicKeyReq, TGetRequestedPublicKeyRsp
    },
