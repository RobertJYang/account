...
function TChangedInfoItem:unpack(_) return self.Field, self.Value end
...
local function TPort_from_obj(obj) return setmetatable(obj, TPort) end

function TPort.new(Id, EthId, DeviceId, DevicePortId, Silkscreen, Type,
                   AdaptiveFlag, LinkStatus, Mac)
...
TPort.proto_property = {
    'Id', 'EthId', 'DeviceId', 'DevicePortId', 'Silkscreen', 'Type',
    'AdaptiveFlag', 'LinkStatus', 'Mac'
}
...
function TPort:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'Id', self.Id, "uint8", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'EthId', self.EthId, "uint8", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'DeviceId', self.DeviceId, "uint8", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'DevicePortId', self.DevicePortId, "uint8",
                      false, errs, need_convert)
    validate.Optional(prefix .. 'Silkscreen', self.Silkscreen, "string", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'Type', self.Type, "string", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'AdaptiveFlag', self.AdaptiveFlag, "bool",
                      false, errs, need_convert)
    validate.Optional(prefix .. 'LinkStatus', self.LinkStatus, "string", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'Mac', self.Mac, "string", false, errs,
                      need_convert)
...
function TPort:unpack(_)
    return self.Id, self.EthId, self.DeviceId, self.DevicePortId,
           self.Silkscreen, self.Type, self.AdaptiveFlag, self.LinkStatus,
           self.Mac
end
...
function TDefaultFactoryIpVersion.new(DefaultFactoryIpVersion)
    return TDefaultFactoryIpVersion_from_obj({
        DefaultFactoryIpVersion = DefaultFactoryIpVersion or [=[IPv4AndIPv6]=]
    })
end
---@param obj EthernetInterfaces.DefaultFactoryIpVersion
function TDefaultFactoryIpVersion:init_from_obj(obj)
    self.DefaultFactoryIpVersion = obj.DefaultFactoryIpVersion or
                                       [=[IPv4AndIPv6]=]
end
...
TDefaultFactoryIpVersion.struct = {
    {name = 'DefaultFactoryIpVersion', is_array = false, struct = nil}
}

function TDefaultFactoryIpVersion:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'DefaultFactoryIpVersion',
                      self.DefaultFactoryIpVersion, "string", true, errs,
                      need_convert)

    if self.DefaultFactoryIpVersion ~= nil then
        validate.Enum(prefix .. 'DefaultFactoryIpVersion',
                      self.DefaultFactoryIpVersion, '',
                      {"IPv4", "IPv6", "IPv4AndIPv6"}, errs, need_convert)
    end

    TDefaultFactoryIpVersion:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TDefaultFactoryIpVersion.proto_property,
                                 errs, need_convert)
    return self
end

function TDefaultFactoryIpVersion:unpack(_) return self.DefaultFactoryIpVersion end
...
function TDefaultFactoryIpv6Addr.new(DefaultFactoryIpv6Addr)
    return TDefaultFactoryIpv6Addr_from_obj({
        DefaultFactoryIpv6Addr = DefaultFactoryIpv6Addr
    })
end
...
TDefaultFactoryIpv6Addr.struct = {
    {name = 'DefaultFactoryIpv6Addr', is_array = false, struct = nil}
}

function TDefaultFactoryIpv6Addr:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'DefaultFactoryIpv6Addr',
                      self.DefaultFactoryIpv6Addr, "string", true, errs,
                      need_convert)

    TDefaultFactoryIpv6Addr:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TDefaultFactoryIpv6Addr.proto_property,
                                 errs, need_convert)
    return self
end

function TDefaultFactoryIpv6Addr:unpack(_) return self.DefaultFactoryIpv6Addr end
...
function TDefaultFactoryIpv6Mode.new(DefaultFactoryIpv6Mode)
    return TDefaultFactoryIpv6Mode_from_obj({
        DefaultFactoryIpv6Mode = DefaultFactoryIpv6Mode or [=[DHCPv6]=]
    })
end
...
TDefaultFactoryIpv6Mode.struct = {
    {name = 'DefaultFactoryIpv6Mode', is_array = false, struct = nil}
}

function TDefaultFactoryIpv6Mode:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'DefaultFactoryIpv6Mode',
                      self.DefaultFactoryIpv6Mode, "string", true, errs,
                      need_convert)

    if self.DefaultFactoryIpv6Mode ~= nil then
        validate.Enum(prefix .. 'DefaultFactoryIpv6Mode',
                      self.DefaultFactoryIpv6Mode, '', {"DHCPv6", "Static"},
                      errs, need_convert)
    end

    TDefaultFactoryIpv6Mode:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TDefaultFactoryIpv6Mode.proto_property,
                                 errs, need_convert)
    return self
end

function TDefaultFactoryIpv6Mode:unpack(_) return self.DefaultFactoryIpv6Mode end
...
function TDefaultFactoryIpAddr.new(DefaultFactoryIpAddr)
    return TDefaultFactoryIpAddr_from_obj({
        DefaultFactoryIpAddr = DefaultFactoryIpAddr
    })
end
...
TDefaultFactoryIpAddr.struct = {
    {name = 'DefaultFactoryIpAddr', is_array = false, struct = nil}
}

function TDefaultFactoryIpAddr:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'DefaultFactoryIpAddr',
                      self.DefaultFactoryIpAddr, "string", true, errs,
                      need_convert)

    TDefaultFactoryIpAddr:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TDefaultFactoryIpAddr.proto_property,
                                 errs, need_convert)
    return self
end

function TDefaultFactoryIpAddr:unpack(_) return self.DefaultFactoryIpAddr end
...
function TDefaultFactoryIpMode.new(DefaultFactoryIpMode)
    return TDefaultFactoryIpMode_from_obj({
        DefaultFactoryIpMode = DefaultFactoryIpMode
    })
end
...
TDefaultFactoryIpMode.struct = {
    {name = 'DefaultFactoryIpMode', is_array = false, struct = nil}
}

function TDefaultFactoryIpMode:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'DefaultFactoryIpMode',
                      self.DefaultFactoryIpMode, "string", true, errs,
                      need_convert)

    if self.DefaultFactoryIpMode ~= nil then
        validate.Enum(prefix .. 'DefaultFactoryIpMode',
                      self.DefaultFactoryIpMode, '', {"DHCP", "Static"}, errs,
                      need_convert)
    end

    TDefaultFactoryIpMode:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TDefaultFactoryIpMode.proto_property,
                                 errs, need_convert)
    return self
end

function TDefaultFactoryIpMode:unpack(_) return self.DefaultFactoryIpMode end
...
TBackupIpActivated.struct = {
    {name = 'BackupIpActivated', is_array = false, struct = nil}
}

function TBackupIpActivated:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'BackupIpActivated', self.BackupIpActivated,
                      "bool", true, errs, need_convert)

    TBackupIpActivated:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TBackupIpActivated.proto_property, errs,
                                 need_convert)
    return self
end

function TBackupIpActivated:unpack(_) return self.BackupIpActivated end
...
TLinkLocalAddress.struct = {
    {name = 'LinkLocalAddress', is_array = false, struct = nil}
}

function TLinkLocalAddress:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'LinkLocalAddress', self.LinkLocalAddress,
                      "string", true, errs, need_convert)

    TLinkLocalAddress:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TLinkLocalAddress.proto_property, errs,
                                 need_convert)
    return self
end

function TLinkLocalAddress:unpack(_) return self.LinkLocalAddress end
...
TSLAACAddressList.struct = {
    {name = 'SLAACAddressList', is_array = true, struct = nil}
}

function TSLAACAddressList:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.OptionalArray(prefix .. 'SLAACAddressList', self.SLAACAddressList,
                           "string", true, errs, need_convert)

    TSLAACAddressList:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TSLAACAddressList.proto_property, errs,
                                 need_convert)
    return self
end

function TSLAACAddressList:unpack(_) return self.SLAACAddressList end
...
local function TVLANId_from_obj(obj) return setmetatable(obj, TVLANId) end

function TVLANId.new(VLANId) return TVLANId_from_obj({VLANId = VLANId}) end
---@param obj EthernetInterfaces.VLANId
function TVLANId:init_from_obj(obj) self.VLANId = obj.VLANId end
...
function TVLANId:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'VLANId', self.VLANId, "uint16", true, errs,
                      need_convert)

    TVLANId:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TVLANId.proto_property, errs,
                                 need_convert)
    return self
end

function TVLANId:unpack(_) return self.VLANId end
...
local function TVLANEnable_from_obj(obj) return setmetatable(obj, TVLANEnable) end
...
function TVLANEnable:init_from_obj(obj) self.VLANEnable = obj.VLANEnable end
...
function TVLANEnable:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'VLANEnable', self.VLANEnable, "bool", true,
                      errs, need_convert)

    TVLANEnable:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TVLANEnable.proto_property, errs,
                                 need_convert)
    return self
end

function TVLANEnable:unpack(_) return self.VLANEnable end
...
local function TPortId_from_obj(obj) return setmetatable(obj, TPortId) end

function TPortId.new(PortId) return TPortId_from_obj({PortId = PortId}) end
---@param obj EthernetInterfaces.PortId
function TPortId:init_from_obj(obj) self.PortId = obj.PortId end
...
function TPortId:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'PortId', self.PortId, "uint8", true, errs,
                      need_convert)

    TPortId:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TPortId.proto_property, errs,
                                 need_convert)
    return self
end

function TPortId:unpack(_) return self.PortId end
...
local function TNcsiEnable_from_obj(obj) return setmetatable(obj, TNcsiEnable) end
...
function TNcsiEnable:init_from_obj(obj) self.NcsiEnable = obj.NcsiEnable end
...
function TNcsiEnable:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'NcsiEnable', self.NcsiEnable, "bool", true,
                      errs, need_convert)

    TNcsiEnable:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TNcsiEnable.proto_property, errs,
                                 need_convert)
    return self
end

function TNcsiEnable:unpack(_) return self.NcsiEnable end
...
local function TIpVersion_from_obj(obj) return setmetatable(obj, TIpVersion) end

function TIpVersion.new(IpVersion)
    return TIpVersion_from_obj({IpVersion = IpVersion})
end
---@param obj EthernetInterfaces.IpVersion
function TIpVersion:init_from_obj(obj) self.IpVersion = obj.IpVersion end
...
function TIpVersion:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'IpVersion', self.IpVersion, "string", false,
                      errs, need_convert)

    if self.IpVersion ~= nil then
        validate.Enum(prefix .. 'IpVersion', self.IpVersion, '',
                      {"IPv4", "IPv6", "IPv4AndIPv6"}, errs, need_convert)
    end

    TIpVersion:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TIpVersion.proto_property, errs,
                                 need_convert)
    return self
end

function TIpVersion:unpack(_) return self.IpVersion end
...
local function TMac_from_obj(obj) return setmetatable(obj, TMac) end

function TMac.new(Mac) return TMac_from_obj({Mac = Mac}) end
---@param obj EthernetInterfaces.Mac
function TMac:init_from_obj(obj) self.Mac = obj.Mac end
...
function TMac:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'Mac', self.Mac, "string", true, errs,
                      need_convert)
...
function TMac:unpack(_) return self.Mac end
...
local function TNetMode_from_obj(obj) return setmetatable(obj, TNetMode) end

function TNetMode.new(NetMode) return TNetMode_from_obj({NetMode = NetMode}) end
---@param obj EthernetInterfaces.NetMode
function TNetMode:init_from_obj(obj) self.NetMode = obj.NetMode end
...
function TNetMode:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'NetMode', self.NetMode, "string", false, errs,
                      need_convert)

    if self.NetMode ~= nil then
        validate.Enum(prefix .. 'NetMode', self.NetMode, '',
                      {"Fixed", "Automatic"}, errs, need_convert)
    end

    TNetMode:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TNetMode.proto_property, errs,
                                 need_convert)
    return self
end

function TNetMode:unpack(_) return self.NetMode end
...
local function TEthName_from_obj(obj) return setmetatable(obj, TEthName) end

function TEthName.new(EthName) return TEthName_from_obj({EthName = EthName}) end
---@param obj EthernetInterfaces.EthName
function TEthName:init_from_obj(obj) self.EthName = obj.EthName end
...
function TEthName:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'EthName', self.EthName, "string", true, errs,
                      need_convert)

    TEthName:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TEthName.proto_property, errs,
                                 need_convert)
    return self
end

function TEthName:unpack(_) return self.EthName end
...
function TEthMacChangedSignalSignature.new(EthName, Mac)
    return
        TEthMacChangedSignalSignature_from_obj({EthName = EthName, Mac = Mac})
end
...
TEthMacChangedSignalSignature.struct = {
    {name = 'EthName', is_array = false, struct = nil},
    {name = 'Mac', is_array = false, struct = nil}
}
...
function TEthMacChangedSignalSignature:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'EthName', self.EthName, "string", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'Mac', self.Mac, "string", false, errs,
                      need_convert)
    ...
    validate.CheckUnknowProperty(self,
                                 TEthMacChangedSignalSignature.proto_property,
                                 errs, need_convert)
    return self
end

function TEthMacChangedSignalSignature:unpack(_) return self.EthName, self.Mac end
...
local function TNCSIInfoChangedSignalSignature_from_obj(obj)
    obj.ChangedInfo = utils.from_obj(EthernetInterfaces.ChangedInfoItem,
                                     obj.ChangedInfo, true)
...
TNCSIInfoChangedSignalSignature.from_obj =
    TNCSIInfoChangedSignalSignature_from_obj
...
TNCSIInfoChangedSignalSignature.struct = {
    {
        name = 'ChangedInfo',
        is_array = true,
        struct = EthernetInterfaces.ChangedInfoItem.struct
    }
}
...
function TNCSIInfoChangedSignalSignature:validate(prefix, errs, need_convert)
    ...
    for _, v in pairs(self.ChangedInfo) do
        EthernetInterfaces.ChangedInfoItem.new(v.Field, v.Value):validate(
            prefix, errs, need_convert)
    end

    TNCSIInfoChangedSignalSignature:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self,
                                 TNCSIInfoChangedSignalSignature.proto_property,
                                 errs, need_convert)
    return self
end
...
EthernetInterfaces.NCSIInfoChangedSignalSignature =
    TNCSIInfoChangedSignalSignature
...
function TActivePortChangedSignalSignature.new(OldPortId, PortId)
    return TActivePortChangedSignalSignature_from_obj({
        OldPortId = OldPortId,
        PortId = PortId
    })
end
...
TActivePortChangedSignalSignature.from_obj =
    TActivePortChangedSignalSignature_from_obj
...
TActivePortChangedSignalSignature.struct = {
    {name = 'OldPortId', is_array = false, struct = nil},
...
function TActivePortChangedSignalSignature:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'OldPortId', self.OldPortId, "uint8", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'PortId', self.PortId, "uint8", false, errs,
                      need_convert)

    TActivePortChangedSignalSignature:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self,
                                 TActivePortChangedSignalSignature.proto_property,
                                 errs, need_convert)
    return self
end
...
EthernetInterfaces.ActivePortChangedSignalSignature =
    TActivePortChangedSignalSignature
...
function TNetworkFailoverRsp:init_from_obj(obj) self.Result = obj.Result end
...
function TNetworkFailoverRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TNetworkFailoverRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TNetworkFailoverRsp:unpack(_) return self.Result end
...
TNetworkFailoverReq.struct = {
    {name = 'From', is_array = false, struct = nil},
    {name = 'To', is_array = false, struct = nil}
}

function TNetworkFailoverReq:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'From', self.From, "string", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'To', self.To, "string", false, errs,
                      need_convert)

    TNetworkFailoverReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TNetworkFailoverReq.proto_property, errs,
                                 need_convert)
    return self
end

function TNetworkFailoverReq:unpack(_) return self.From, self.To end
...
function TSetEthStateRsp:init_from_obj(obj) self.Result = obj.Result end
...
function TSetEthStateRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetEthStateRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TSetEthStateRsp:unpack(_) return self.Result end
...
function TSetEthStateReq.new(EthName, EthEnabled)
    return
        TSetEthStateReq_from_obj({EthName = EthName, EthEnabled = EthEnabled})
end
...
TSetEthStateReq.struct = {
    {name = 'EthName', is_array = false, struct = nil},
    {name = 'EthEnabled', is_array = false, struct = nil}
}
...
function TSetEthStateReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'EthName', self.EthName, "string", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'EthEnabled', self.EthEnabled, "bool", false,
                      errs, need_convert)

    TSetEthStateReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TSetEthStateReq.proto_property, errs,
                                 need_convert)
    return self
end

function TSetEthStateReq:unpack(_) return self.EthName, self.EthEnabled end
...
function TSetVLANConfigRsp:init_from_obj(obj) self.Result = obj.Result end
...
function TSetVLANConfigRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetVLANConfigRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TSetVLANConfigRsp:unpack(_) return self.Result end
...
function TSetVLANConfigReq.new(VLANEnabled, VLANId, PortType)
    return TSetVLANConfigReq_from_obj({
...
TSetVLANConfigReq.struct = {
    {name = 'VLANEnabled', is_array = false, struct = nil},
...
function TSetVLANConfigReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'VLANEnabled', self.VLANEnabled, "bool", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'VLANId', self.VLANId, "uint16", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'PortType', self.PortType, "uint8", false, errs,
                      need_convert)

    TSetVLANConfigReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TSetVLANConfigReq.proto_property, errs,
                                 need_convert)
    return self
end
...
function TAddIp6tablesRuleRsp:init_from_obj(obj) self.Result = obj.Result end
...
function TAddIp6tablesRuleRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TAddIp6tablesRuleRsp.proto_property,
                                 errs, need_convert)
    return self
end

function TAddIp6tablesRuleRsp:unpack(_) return self.Result end
...
function TAddIp6tablesRuleReq.new(InterfaceName, Ipv6Addr)
    return TAddIp6tablesRuleReq_from_obj({
...
TAddIp6tablesRuleReq.struct = {
    {name = 'InterfaceName', is_array = false, struct = nil},
    {name = 'Ipv6Addr', is_array = false, struct = nil}
}

function TAddIp6tablesRuleReq:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'InterfaceName', self.InterfaceName, "string",
                      false, errs, need_convert)
    validate.Optional(prefix .. 'Ipv6Addr', self.Ipv6Addr, "string", false,
                      errs, need_convert)

    TAddIp6tablesRuleReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TAddIp6tablesRuleReq.proto_property,
                                 errs, need_convert)
    return self
end

function TAddIp6tablesRuleReq:unpack(_) return self.InterfaceName, self.Ipv6Addr end
...
function TAddIptablesRuleRsp:init_from_obj(obj) self.Result = obj.Result end
...
function TAddIptablesRuleRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TAddIptablesRuleRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TAddIptablesRuleRsp:unpack(_) return self.Result end
...
function TAddIptablesRuleReq.new(InterfaceName, IpAddr)
    return TAddIptablesRuleReq_from_obj({
        InterfaceName = InterfaceName,
        IpAddr = IpAddr
    })
end
...
function TAddIptablesRuleReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TAddIptablesRuleReq.proto_property, errs,
                                 need_convert)
    return self
end

function TAddIptablesRuleReq:unpack(_) return self.InterfaceName, self.IpAddr end
...
function TDeleteMgmtPortRsp.new() return TDeleteMgmtPortRsp_from_obj({}) end
---@param obj EthernetInterfaces.DeleteMgmtPortRsp
function TDeleteMgmtPortRsp:init_from_obj(obj) end
...
function TDeleteMgmtPortRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TDeleteMgmtPortRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TDeleteMgmtPortRsp:unpack(_) end
...
function TDeleteMgmtPortReq:init_from_obj(obj) self.PortId = obj.PortId end
...
function TDeleteMgmtPortReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TDeleteMgmtPortReq.proto_property, errs,
                                 need_convert)
    return self
end

function TDeleteMgmtPortReq:unpack(_) return self.PortId end
...
function TAddMgmtPortRsp:init_from_obj(obj) self.PortId = obj.PortId end
...
function TAddMgmtPortRsp:unpack(_) return self.PortId end
...
function TAddMgmtPortReq.new(DeviceId, DevicePortId, Silkscreen, EthId, Type,
                             PortId)
...
function TAddMgmtPortReq:unpack(_)
    return self.DeviceId, self.DevicePortId, self.Silkscreen, self.EthId,
           self.Type, self.PortId
end
...
function TSetNetworkConfigRsp.new() return TSetNetworkConfigRsp_from_obj({}) end
---@param obj EthernetInterfaces.SetNetworkConfigRsp
function TSetNetworkConfigRsp:init_from_obj(obj) end
...
function TSetNetworkConfigRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetNetworkConfigRsp.proto_property,
                                 errs, need_convert)
    return self
end

function TSetNetworkConfigRsp:unpack(_) end
...
TSetNetworkConfigReq.proto_property = {
    'NetMode', 'PortId', 'VLANEnable', 'VLANId'
}
...
function TSetNetworkConfigReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'PortId', self.PortId, "uint8", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'VLANEnable', self.VLANEnable, "bool", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'VLANId', self.VLANId, "uint16", false, errs,
                      need_convert)

    TSetNetworkConfigReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TSetNetworkConfigReq.proto_property,
                                 errs, need_convert)
    return self
end
...
function TGetAllPortRsp.new(Port) return TGetAllPortRsp_from_obj({Port = Port}) end
---@param obj EthernetInterfaces.GetAllPortRsp
function TGetAllPortRsp:init_from_obj(obj) self.Port = obj.Port end
...
TGetAllPortRsp.struct = {
    {name = 'Port', is_array = true, struct = EthernetInterfaces.Port.struct}
}
...
function TGetAllPortRsp:validate(prefix, errs, need_convert)
    ...
    for _, v in pairs(self.Port) do
        EthernetInterfaces.Port.new(v.Id, v.EthId, v.DeviceId, v.DevicePortId,
                                    v.Silkscreen, v.Type, v.AdaptiveFlag,
                                    v.LinkStatus, v.Mac):validate(prefix, errs,
                                                                  need_convert)
    end
...
function TGetAllPortRsp:unpack(raw) return utils.unpack(raw, self.Port, true) end
...
function TGetAllPortReq.new() return TGetAllPortReq_from_obj({}) end
---@param obj EthernetInterfaces.GetAllPortReq
function TGetAllPortReq:init_from_obj(obj) end
...
function TGetAllPortReq:unpack(_) end

EthernetInterfaces.GetAllPortReq = TGetAllPortReq

EthernetInterfaces.interface = mdb.register_interface(
        ...
        SetNetworkConfig = {
            'a{ss}sybq', '', TSetNetworkConfigReq, TSetNetworkConfigRsp
        },
        AddMgmtPort = {'a{ss}yysysy', 'y', TAddMgmtPortReq, TAddMgmtPortRsp},
        DeleteMgmtPort = {'a{ss}y', '', TDeleteMgmtPortReq, TDeleteMgmtPortRsp},
        AddIptablesRule = {
            'a{ss}ss', 'b', TAddIptablesRuleReq, TAddIptablesRuleRsp
        },
        AddIp6tablesRule = {
            'a{ss}ss', 'b', TAddIp6tablesRuleReq, TAddIp6tablesRuleRsp
        },
        SetVLANConfig = {'a{ss}bqy', 'b', TSetVLANConfigReq, TSetVLANConfigRsp},
        SetEthState = {'a{ss}sb', 'b', TSetEthStateReq, TSetEthStateRsp},
        NetworkFailover = {
            'a{ss}ss', 'b', TNetworkFailoverReq, TNetworkFailoverRsp
        }
    }, {
        ActivePortChangedSignal = 'a{ss}yy',
        NCSIInfoChangedSignal = 'a{ss}a(ss)',
        EthMacChangedSignal = 'a{ss}ss'
    })
