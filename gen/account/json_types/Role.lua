...
TRolePrivilege.struct = {
    {name = 'RolePrivilege', is_array = true, struct = nil}
}

function TRolePrivilege:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.OptionalArray(prefix .. 'RolePrivilege', self.RolePrivilege,
                           "string", true, errs, need_convert)

    TRolePrivilege:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TRolePrivilege.proto_property, errs,
                                 need_convert)
    return self
end

function TRolePrivilege:unpack(_) return self.RolePrivilege end
...
function TSetRolePrivilegeRsp.new() return TSetRolePrivilegeRsp_from_obj({}) end
---@param obj Role.SetRolePrivilegeRsp
function TSetRolePrivilegeRsp:init_from_obj(obj) end
...
function TSetRolePrivilegeRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetRolePrivilegeRsp.proto_property,
                                 errs, need_convert)
    return self
end

function TSetRolePrivilegeRsp:unpack(_) end
...
function TSetRolePrivilegeReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'PrivilegeType', self.PrivilegeType, "uint8",
                      false, errs, need_convert)
    validate.Optional(prefix .. 'PrivilegeValue', self.PrivilegeValue, "bool",
                      false, errs, need_convert)

    TSetRolePrivilegeReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TSetRolePrivilegeReq.proto_property,
                                 errs, need_convert)
    return self
end
...
Role.interface = mdb.register_interface('bmc.kepler.AccountService.Role', {
    ...
    SetRolePrivilege = {
        'a{ss}yb', '', TSetRolePrivilegeReq, TSetRolePrivilegeRsp
    }
}, {})
