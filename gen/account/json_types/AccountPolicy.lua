...
TAllowedLoginInterfaces.struct = {
    {name = 'AllowedLoginInterfaces', is_array = true, struct = nil}
}

function TAllowedLoginInterfaces:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.OptionalArray(prefix .. 'AllowedLoginInterfaces',
                           self.AllowedLoginInterfaces, "string", false, errs,
                           need_convert)
...
AccountPolicy.interface = mdb.register_interface(
        ...
        AllowedLoginInterfaces = {
            'as', {}, false,
            {'Web', 'SNMP', 'IPMI', 'SSH', 'SFTP', 'Local', 'Redfish'}, false
        }
    }, {}, {})
