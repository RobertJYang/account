...
TSnmpPasswordChangedSignalSignature.__index =
    TSnmpPasswordChangedSignalSignature
...
TSnmpPasswordChangedSignalSignature.from_obj =
    TSnmpPasswordChangedSignalSignature_from_obj

TSnmpPasswordChangedSignalSignature.proto_property = {'AccountId'}

TSnmpPasswordChangedSignalSignature.default = {0}

TSnmpPasswordChangedSignalSignature.struct = {
...
function TSnmpPasswordChangedSignalSignature:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self,
                                 TSnmpPasswordChangedSignalSignature.proto_property,
                                 errs, need_convert)
    return self
end

function TSnmpPasswordChangedSignalSignature:unpack(_) return self.AccountId end

ManagerAccounts.SnmpPasswordChangedSignalSignature =
    TSnmpPasswordChangedSignalSignature
...
TPasswordChangedSignalSignature.from_obj =
    TPasswordChangedSignalSignature_from_obj

TPasswordChangedSignalSignature.proto_property = {'AccountId'}

TPasswordChangedSignalSignature.default = {0}

TPasswordChangedSignalSignature.struct = {
    {name = 'AccountId', is_array = false, struct = nil}
}
...
function TPasswordChangedSignalSignature:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self,
                                 TPasswordChangedSignalSignature.proto_property,
                                 errs, need_convert)
    return self
end

function TPasswordChangedSignalSignature:unpack(_) return self.AccountId end
...
function TSetAccountLockStateRsp:init_from_obj(obj) end
...
function TSetAccountLockStateRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetAccountLockStateRsp.proto_property,
                                 errs, need_convert)
    return self
end

function TSetAccountLockStateRsp:unpack(_) end
...
function TSetAccountLockStateReq.new(AccountId, Lockstatus)
    return TSetAccountLockStateReq_from_obj({
        AccountId = AccountId,
...
TSetAccountLockStateReq.struct = {
    {name = 'AccountId', is_array = false, struct = nil},
    {name = 'Lockstatus', is_array = false, struct = nil}
}
...
function TSetAccountLockStateReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'AccountId', self.AccountId, "uint8", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'Lockstatus', self.Lockstatus, "bool", false,
                      errs, need_convert)

    if self.AccountId ~= nil then
        validate.ranges(prefix .. 'AccountId', self.AccountId, 2, 115, errs,
                        need_convert)
    end

    TSetAccountLockStateReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TSetAccountLockStateReq.proto_property,
                                 errs, need_convert)
    return self
end

function TSetAccountLockStateReq:unpack(_) return self.AccountId,
                                                  self.Lockstatus end
...
function TGetAccountWritableReq:init_from_obj(obj) self.AccountId =
    obj.AccountId end
...
function TGetAccountWritableReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TGetAccountWritableReq.proto_property,
                                 errs, need_convert)
    return self
end

function TGetAccountWritableReq:unpack(_) return self.AccountId end
...
function TSetAccountWritableRsp.new() return TSetAccountWritableRsp_from_obj({}) end
---@param obj ManagerAccounts.SetAccountWritableRsp
function TSetAccountWritableRsp:init_from_obj(obj) end
...
function TSetAccountWritableRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetAccountWritableRsp.proto_property,
                                 errs, need_convert)
    return self
end
...
function TGetIdByUserNameRsp:init_from_obj(obj) self.AccountId = obj.AccountId end
...
function TGetIdByUserNameRsp:unpack(_) return self.AccountId end
...
function TGetIdByUserNameReq:init_from_obj(obj) self.UserName = obj.UserName end
...
function TGetIdByUserNameReq:unpack(_) return self.UserName end
...
function TNewOEMAccountRsp:init_from_obj(obj) self.AccountId = obj.AccountId end
...
function TNewOEMAccountRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TNewOEMAccountRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TNewOEMAccountRsp:unpack(_) return self.AccountId end
...
local function TNewRsp_from_obj(obj) return setmetatable(obj, TNewRsp) end

function TNewRsp.new(AccountId) return TNewRsp_from_obj({AccountId = AccountId}) end
---@param obj ManagerAccounts.NewRsp
function TNewRsp:init_from_obj(obj) self.AccountId = obj.AccountId end
...
function TNewRsp:unpack(_) return self.AccountId end
...
local function TExtraData_from_obj(obj) return setmetatable(obj, TExtraData) end

function TExtraData.new(dict) return TExtraData_from_obj(dict) end

---@param obj ManagerAccounts.ExtraData
function TExtraData:init_from_obj(obj) self = obj end
...
function TExtraData:unpack(_) return self end
...
TNewOEMAccountReq.proto_property = {
    'AccountId', 'UserName', 'Password', 'ExtraData'
}
...
TNewOEMAccountReq.struct = {
    ...
    {name = 'Password', is_array = false, struct = nil}, {
        name = 'ExtraData',
        is_array = false,
        struct = ManagerAccounts.ExtraData.struct
    }
}
...
function TNewOEMAccountReq:validate(prefix, errs, need_convert)
    ...
    ManagerAccounts.ExtraData.new(self.ExtraData):validate(prefix, errs,
                                                           need_convert)
    ...
    if self.AccountId ~= nil then
        validate.ranges(prefix .. 'AccountId', self.AccountId, 101, 115, errs,
                        need_convert)
    end
    if self.UserName ~= nil then
        validate.lens(prefix .. 'UserName', self.UserName, 1, 32, errs,
    ...
    if self.Password ~= nil then
        validate.lens(prefix .. 'Password', self.Password, 1, 1024, errs,
                      need_convert)
    end

    TNewOEMAccountReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TNewOEMAccountReq.proto_property, errs,
                                 need_convert)
    return self
end
...
function TPropertyWritable.new(dict) return TPropertyWritable_from_obj(dict) end

---@param obj ManagerAccounts.PropertyWritable
function TPropertyWritable:init_from_obj(obj) self = obj end
...
function TPropertyWritable:validate(prefix, errs, need_convert)
    ...
    for k, v in pairs(self) do
        ...
        validate.Optional(prefix .. 'value', v, "bool", false, errs,
                          need_convert)
...
function TPropertyWritable:unpack(_) return self end
...
function TGetAccountWritableRsp.new(PropertiesWritable)
    return TGetAccountWritableRsp_from_obj({
        PropertiesWritable = PropertiesWritable
    })
end
...
TGetAccountWritableRsp.struct = {
    {
        name = 'PropertiesWritable',
        is_array = false,
        struct = ManagerAccounts.PropertyWritable.struct
    }
}
...
function TGetAccountWritableRsp:validate(prefix, errs, need_convert)
    ...
    ManagerAccounts.PropertyWritable.new(self.PropertiesWritable):validate(
        prefix, errs, need_convert)

    TGetAccountWritableRsp:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TGetAccountWritableRsp.proto_property,
                                 errs, need_convert)
    return self
end

function TGetAccountWritableRsp:unpack(_) return self.PropertiesWritable end
...
function TSetAccountWritableReq.new(AccountId, PropertiesWritable)
    return TSetAccountWritableReq_from_obj({
        AccountId = AccountId,
        PropertiesWritable = PropertiesWritable
    })
end
...
function TSetAccountWritableReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TSetAccountWritableReq.proto_property,
                                 errs, need_convert)
    return self
end
...
local function TNewReq_from_obj(obj)
    ...
    obj.LoginInterface = utils.from_obj(ManagerAccounts.LoginInterfaceType,
                                        obj.LoginInterface, true)
    obj.FirstLoginPolicy = obj.FirstLoginPolicy and
                               ManagerAccounts.FirstLoginPolicy
                                   .new(obj.FirstLoginPolicy)
...
TNewReq.proto_property = {
    'AccountId', 'UserName', 'Password', 'RoleId', 'LoginInterface',
    'FirstLoginPolicy'
}

TNewReq.default = {
    0, '', {}, ManagerAccounts.RoleType.default, {},
    ManagerAccounts.FirstLoginPolicy.default
}
...
TNewReq.struct = {
    ...
    {name = 'Password', is_array = true, struct = nil},
    {
        name = 'RoleId',
        is_array = false,
        struct = ManagerAccounts.RoleType.struct
    }, {
        name = 'LoginInterface',
        is_array = true,
        struct = ManagerAccounts.LoginInterfaceType.struct
    }, {
        name = 'FirstLoginPolicy',
        is_array = false,
        struct = ManagerAccounts.FirstLoginPolicy.struct
    }
}
...
function TNewReq:validate(prefix, errs, need_convert)
    ...
    validate.OptionalArray(prefix .. 'Password', self.Password, "uint8", false,
                           errs, need_convert)
    validate.Optional(prefix .. 'RoleId', self.RoleId,
                      "ManagerAccounts.RoleType", false, errs, need_convert)
    validate.OptionalArray(prefix .. 'LoginInterface', self.LoginInterface,
                           "ManagerAccounts.LoginInterfaceType", false, errs,
                           need_convert)
    validate.Optional(prefix .. 'FirstLoginPolicy', self.FirstLoginPolicy,
                      "ManagerAccounts.FirstLoginPolicy", false, errs,
                      need_convert)

    if self.AccountId ~= nil then
        validate.ranges(prefix .. 'AccountId', self.AccountId, 0, 17, errs,
                        need_convert)
    end
    if self.UserName ~= nil then
        validate.lens(prefix .. 'UserName', self.UserName, 1, 32, errs,
    ...
    if self.Password ~= nil then
        validate.lens(prefix .. 'Password', self.Password, nil, 32, errs,
                      need_convert)
    end
...
function TNewReq:unpack(raw)
    ...
    local LoginInterface = utils.unpack_enum(raw, utils.from_obj(
                                                 ManagerAccounts.LoginInterfaceType,
                                                 self.LoginInterface, true),
                                             true)
    local FirstLoginPolicy = utils.unpack_enum(raw, self.FirstLoginPolicy)
    return self.AccountId, self.UserName, self.Password, RoleId, LoginInterface,
           FirstLoginPolicy
end

ManagerAccounts.NewReq = TNewReq

ManagerAccounts.interface = mdb.register_interface(
                                'bmc.kepler.AccountService.ManagerAccounts', {},
                                {
        New = {'a{ss}ysayiaii', 'y', TNewReq, TNewRsp},
        NewOEMAccount = {
            'a{ss}yssa{ss}', 'y', TNewOEMAccountReq, TNewOEMAccountRsp
        },
        GetIdByUserName = {
        ...
        GetAccountWritable = {
            'a{ss}y', 'a{sb}', TGetAccountWritableReq, TGetAccountWritableRsp
        },
        SetAccountLockState = {
