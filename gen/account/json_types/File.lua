...
function TIsPermittedRsp:init_from_obj(obj) self.Result = obj.Result end
...
function TIsPermittedRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TIsPermittedRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TIsPermittedRsp:unpack(_) return self.Result end
...
function TIsPermittedReq.new(DstFile, Permission)
    return
        TIsPermittedReq_from_obj({DstFile = DstFile, Permission = Permission})
end
...
TIsPermittedReq.struct = {
    {name = 'DstFile', is_array = false, struct = nil},
    {name = 'Permission', is_array = false, struct = nil}
}

function TIsPermittedReq:validate(prefix, errs, need_convert)
    prefix = prefix or ''

    validate.Optional(prefix .. 'DstFile', self.DstFile, "string", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'Permission', self.Permission, "string", false,
                      errs, need_convert)

    TIsPermittedReq:remove_error_props(errs, self)
    validate.CheckUnknowProperty(self, TIsPermittedReq.proto_property, errs,
                                 need_convert)
    return self
end

function TIsPermittedReq:unpack(_) return self.DstFile, self.Permission end
...
function TChangeOwnerRsp:init_from_obj(obj) self.Result = obj.Result end
...
function TChangeOwnerRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TChangeOwnerRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TChangeOwnerRsp:unpack(_) return self.Result end
...
function TChangeOwnerReq:init_from_obj(obj) self.DstFile = obj.DstFile end
...
function TChangeOwnerReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TChangeOwnerReq.proto_property, errs,
                                 need_convert)
    return self
end

function TChangeOwnerReq:unpack(_) return self.DstFile end
...
local function TCreateRsp_from_obj(obj) return setmetatable(obj, TCreateRsp) end

function TCreateRsp.new() return TCreateRsp_from_obj({}) end
---@param obj File.CreateRsp
function TCreateRsp:init_from_obj(obj) end
...
function TCreateRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TCreateRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TCreateRsp:unpack(_) end
...
local function TCreateReq_from_obj(obj) return setmetatable(obj, TCreateReq) end

function TCreateReq.new(DstFile, OpenMode, FileMode, Uid, Gid)
    return TCreateReq_from_obj({
        DstFile = DstFile,
        OpenMode = OpenMode,
        FileMode = FileMode,
        Uid = Uid,
...
TCreateReq.struct = {
    {name = 'DstFile', is_array = false, struct = nil},
    {name = 'OpenMode', is_array = false, struct = nil},
    {name = 'FileMode', is_array = false, struct = nil},
...
function TCreateReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'DstFile', self.DstFile, "string", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'OpenMode', self.OpenMode, "string", false,
                      errs, need_convert)
    validate.Optional(prefix .. 'FileMode', self.FileMode, "uint32", false,
                      errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TCreateReq.proto_property, errs,
                                 need_convert)
    return self
end
...
function TDeleteReq.new(DstFile) return TDeleteReq_from_obj({DstFile = DstFile}) end
---@param obj File.DeleteReq
function TDeleteReq:init_from_obj(obj) self.DstFile = obj.DstFile end
...
function TDeleteReq:unpack(_) return self.DstFile end
...
local function TChownRsp_from_obj(obj) return setmetatable(obj, TChownRsp) end

function TChownRsp.new() return TChownRsp_from_obj({}) end
---@param obj File.ChownRsp
function TChownRsp:init_from_obj(obj) end
...
function TChownRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TChownRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TChownRsp:unpack(_) end
...
local function TChownReq_from_obj(obj) return setmetatable(obj, TChownReq) end
...
function TChownReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TChownReq.proto_property, errs,
                                 need_convert)
    return self
end

function TChownReq:unpack(_) return self.DstFile, self.Uid, self.Gid end
...
local function TChmodRsp_from_obj(obj) return setmetatable(obj, TChmodRsp) end

function TChmodRsp.new() return TChmodRsp_from_obj({}) end
---@param obj File.ChmodRsp
function TChmodRsp:init_from_obj(obj) end
...
function TChmodRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TChmodRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TChmodRsp:unpack(_) end
...
local function TChmodReq_from_obj(obj) return setmetatable(obj, TChmodReq) end
...
function TChmodReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TChmodReq.proto_property, errs,
                                 need_convert)
    return self
end

function TChmodReq:unpack(_) return self.DstFile, self.FileMode end
...
local function TMoveRsp_from_obj(obj) return setmetatable(obj, TMoveRsp) end

function TMoveRsp.new() return TMoveRsp_from_obj({}) end
---@param obj File.MoveRsp
function TMoveRsp:init_from_obj(obj) end
...
function TMoveRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TMoveRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TMoveRsp:unpack(_) end
...
local function TMoveReq_from_obj(obj) return setmetatable(obj, TMoveReq) end

function TMoveReq.new(SrcFile, DstFile, Uid, Gid)
    return TMoveReq_from_obj({
        SrcFile = SrcFile,
        DstFile = DstFile,
        Uid = Uid,
        Gid = Gid
...
TMoveReq.struct = {
    {name = 'SrcFile', is_array = false, struct = nil},
    {name = 'DstFile', is_array = false, struct = nil},
    {name = 'Uid', is_array = false, struct = nil},
    {name = 'Gid', is_array = false, struct = nil}
}
...
function TMoveReq:validate(prefix, errs, need_convert)
    ...
    validate.Optional(prefix .. 'SrcFile', self.SrcFile, "string", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'DstFile', self.DstFile, "string", false, errs,
                      need_convert)
    validate.Optional(prefix .. 'Uid', self.Uid, "uint32", false, errs,
    ...
    validate.CheckUnknowProperty(self, TMoveReq.proto_property, errs,
                                 need_convert)
    return self
end

function TMoveReq:unpack(_) return self.SrcFile, self.DstFile, self.Uid,
                                   self.Gid end
...
local function TCopyRsp_from_obj(obj) return setmetatable(obj, TCopyRsp) end

function TCopyRsp.new() return TCopyRsp_from_obj({}) end
---@param obj File.CopyRsp
function TCopyRsp:init_from_obj(obj) end
...
function TCopyRsp:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TCopyRsp.proto_property, errs,
                                 need_convert)
    return self
end

function TCopyRsp:unpack(_) end
...
local function TCopyReq_from_obj(obj) return setmetatable(obj, TCopyReq) end

function TCopyReq.new(SrcFile, DstFile, Uid, Gid)
    return TCopyReq_from_obj({
        SrcFile = SrcFile,
        DstFile = DstFile,
        Uid = Uid,
        Gid = Gid
...
function TCopyReq:validate(prefix, errs, need_convert)
    ...
    validate.CheckUnknowProperty(self, TCopyReq.proto_property, errs,
                                 need_convert)
    return self
end

function TCopyReq:unpack(_) return self.SrcFile, self.DstFile, self.Uid,
                                   self.Gid end
